...
class LocationHelper {
    ...
    static findLocation(callback) {
        ...
        if(document.getElementById("latitude").getAttribute("value")==-1){
        geoLocationApi.getCurrentPosition((location) => {
            ...
            let helper = new LocationHelper();
            helper.#latitude = document.getElementById("latitude").getAttribute("value");
            helper.#longitude = document.getElementById("longitude").getAttribute("value");
            callback(helper);
        }
