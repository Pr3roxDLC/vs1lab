...
router.get('/api/geotags', (req, res)=>{
  res.json(GeoTagStore.searchNearbyGeoTags(
...
router.post('/api/geotags', (req, res)=>{
  ...
  res.status(201).location('api/geotags/'+geoTag.id).json(geoTag);
})
...
router.put('/api/geotags/:id', (req, res)=>{
  var geoTag = GeoTagStore.getTagById(req.params.id);
...
router.delete('/api/geotags/:id', (req, res)=>{
  var geoTag = GeoTagStore.getTagById(req.params.id);
  GeoTagStore.removeGeoTagById(req.params.id);
  res.json(geoTag);
})
